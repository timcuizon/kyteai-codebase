...
//Helpers
import { isLoggedIn, formatDate } from "helpers/helpers";
...
function RecordReport({ email, report }) {
  ...
  const cols = [
    ...
    { field: "id", headerName: "Ref No.", width: 80, headerAlign: "center", align: "center" },
    {
      field: "status",
      headerName: "Status",
      width: 80,
    ...
    },
    {
      ...
      headerAlign: "center",
      align: "center",
      renderCell: (params) => <span>{dayjs(params.row.created_at, "DD/MM/YYYY hh:mm:ss a").format("MMMM DD, YYYY")}</span>,
    },
    {
      field: "updated_at",
      ...
      headerAlign: "center",
      align: "center",
      renderCell: (params) => <span>{dayjs(params.row.updated_at, "DD/MM/YYYY hh:mm:ss a").format("MMMM DD, YYYY")}</span>,
    },
  ];
